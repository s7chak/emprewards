...
ALTER TABLE emprewardz_transact_points ADD CONSTRAINT fk_month1 FOREIGN KEY (month_id0) REFERENCES months(month_id);
...
ALTER TABLE emprewardz_transact_points ADD CONSTRAINT fk_month1 FOREIGN KEY (month_id1) REFERENCES months(month_id);
...
ALTER TABLE emprewardz_transact_points ADD CONSTRAINT fk_month1 FOREIGN KEY (month_id2) REFERENCES months(month_id);
...
Select A.user_id, A.month_id2, A.PointsRedeemed, A.PointsGiven, B.PointsRecieved from
	...
	group by month_id2,user_id) A Left Join
